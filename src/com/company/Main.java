    ...
    public static void main(String[] args) {
        ...
        if (answer1.equalsIgnoreCase("Enter")) {
            ...
            while (!(answer2 = input.nextLine()).equalsIgnoreCase("Leave")) {
                receipt += "\n " + answer2 + " \n";
                purchaseTotal = 0;
                System.out.println("Enter item ('Checkout' when purchase complete):");

                while (!(answer2).equalsIgnoreCase("Checkout")) {
